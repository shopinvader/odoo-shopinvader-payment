...
STRIPE_CAPTURE_METHODS = {
    "immediately": "automatic",
    "order_confirm": "manual",
    "picking_confirm": "manual",
}
...
class PaymentServiceStripe(AbstractComponent):
    ...
    def _capture_stripe_intent(self, transaction, stripe_payment_intent_id):
        """
    ...
    def _get_stripe_capture_method(self, payment_method):
        return STRIPE_CAPTURE_METHODS[payment_method.capture_payment]
