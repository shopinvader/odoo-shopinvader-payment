...
This HTML form must just be submitted by the front to call the Stripe services.
After Stripe has finished, the frontend redirect url will be called back.
