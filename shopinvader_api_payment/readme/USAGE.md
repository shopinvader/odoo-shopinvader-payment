...
2\. Once you chose the payment method you want to use, create the
payment transaction calling the POST route /payment/transactions with
your payable + some additional input info (the chosen provider, the
frontend redirect url...). See the associated TransactionCreate Pydantic
schema.
